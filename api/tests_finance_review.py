...
class DependencyReleaseTests(SimpleTestCase):
    def test_publisher_pin_is_in_deployment_requirements(self):
        ...
        pin = 'masi-finance @ git+https://JimMcKeown17:${MASI_FINANCE_GITHUB_TOKEN}@github.com/JimMcKeown17/masi-finance-app.git@v0.4.0'
    ...
    def test_build_checks_publisher_immediately_after_install(self):
        ...
        check = ("python -c \"from importlib.metadata import version; "
                 ...
                 "assert version('masi-finance') == '0.4.0'; print(verify_installed_contracts())\"")
    ...
    def test_installed_contract_verifier_fails_closed_before_migrate(self):
        ...
        self.assertEqual(set(digests), {'finance-run-2.0.0.json', 'finance-snapshot-1.0.0.json', 'finance-snapshot-1.1.0.json', 'budget-run-1.0.0.json', 'budget-run-1.1.0.json'})
