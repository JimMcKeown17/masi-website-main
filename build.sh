...
python -c "from importlib.metadata import version; from masi_finance.publish.run_schema import verify_installed_contracts; assert version('masi-finance') == '0.3.1'; print(verify_installed_contracts())"
